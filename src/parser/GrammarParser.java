...
public class GrammarParser extends Parser {
	...
	public static final int
		...
		RULE_declaracion = 9, RULE_sentencia = 10, RULE_sentencias = 11, RULE_expresiones = 12, 
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"argumentos", "declaracion", "sentencia", "sentencias", "expresiones", 
			"expr", "tipo"
		};
	}
	...
	public final DeclaracionstructsContext declaracionstructs() throws RecognitionException {
		...
		try {
			...
			while (_la==IDENT) {
				...
				{
				setState(50);
				((DeclaracionstructsContext)_localctx).declaracion = declaracion();
				}
				}
				setState(55);
				_errHandler.sync(this);
			...
			setState(56);
			match(T__2);
			 ((DeclaracionstructsContext)_localctx).ast =  new Declaracionstructs((((DeclaracionstructsContext)_localctx).IDENT!=null?((DeclaracionstructsContext)_localctx).IDENT.getText():null), ((DeclaracionstructsContext)_localctx).declaracion.ast); 
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final TipoContext tipo() throws RecognitionException {
		...
		try {
			...
			case T__35:
				...
				setState(291);
				match(T__35);
				 ((TipoContext)_localctx).ast =  new FloatTipo(); 
				}
				break;
			case T__36:
				enterOuterAlt(_localctx, 3);
