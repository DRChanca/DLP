...
public class LogicExpression extends AbstractExpression  {
	...
	public LogicExpression(Expression left, String operator, Expression right) {
		super();
	...
	public LogicExpression(Object left, Object operator, Object right) {
		super();
    ...
    public String toString() {
        return "LogicExpression{" + " left=" + this.getLeft() + " operator=" + this.getOperator() + " right=" + this.getRight() + "}";
    }
