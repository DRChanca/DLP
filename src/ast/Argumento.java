...
/*
	argumento -> IDENT:string tipo:tipo
*/
public class Argumento extends AbstractAST  {

    // ----------------------------------
    // Instance Variables

	// argumento -> IDENT:string tipo
	...
	public Argumento(String IDENT, Tipo tipo) {
		super();
	...
	public Argumento(Object IDENT, Object tipo) {
		super();
    ...
    public String toString() {
        return "Argumento{" + " IDENT=" + this.getIDENT() + " tipo=" + this.getTipo() + "}";
    }
